...
const Register = ({ history, handleRegister, setIsRegisterview }) => {
    ...
    try {
      await handleRegister({ username, password }); // Assuming handleSignIn handles successful login
      setIsLoading(false);
                ...
                <Box me='auto'>
                    ...
                    <Flex
                        ...
                        <Text color={textColorDetails} fontWeight='400' fontSize='14px'>
                            Already have an account, Sign In? Click
                            <Text
...
const mapDispatch = (dispatch) => ({
    handleRegister: dispatch.Register.handleRegister
});
